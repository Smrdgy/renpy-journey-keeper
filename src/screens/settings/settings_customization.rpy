screen JK_Settings_Customization():
    vbox:
        ...
        hbox:
            bar value JK.Settings.FieldValue(JK.Settings, "dialogOpacity", range=1.0, step=0.01) xsize 0.3
        ...
        hbox:
            bar value JK.Settings.FieldValue(JK.Settings, "sidepanelOpacity", range=1.0, step=0.01) xsize 0.3
        ...
        hbox:
            bar value JK.Settings.FieldValue(JK.Settings, "paginationOpacity", range=1.0, step=0.01) xsize 0.3
