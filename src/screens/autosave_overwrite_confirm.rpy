screen SSSSS_AutosaveOverwriteConfirm():
    default title = _("Are you sure you want to overwrite your save?")
    default message = _("By choosing \"No\", the autosave feature will disable itself until you re-enable it again.")
    ...
    use SSSSS_Dialog(title=title, message=message, closeAction=[SSSSS.Autosaver.ConfirmDialogClose(), Hide("SSSSS_AutosaveOverwriteConfirm")], background="gui/edit_playthrough_dialog_background.png", size=(x52URM.scalePxInt(1000), x52URM.scalePxInt(600))):
        ...
        hbox:
            ...
            button:
                ...
                text _("Overwrite") yalign .5 xalign 0.5 size 28
            ...
            button:
                ...
                text _("Save one over") yalign .5 xalign 0.5 size 28
            ...
            button:
                ...
                text _("No") yalign .5 xalign 0.5 size 28